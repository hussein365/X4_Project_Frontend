...
@Component({
  selector: 'app-batchjob_settings',
  templateUrl: './batchjob_settings.component.html',
  styleUrls: ['./batchjob_settings.component.scss']
})
export class BatchjobSettingsComponent implements OnInit {
